...
const CardSection = ({ warehouseInfo, key }) =>
{
    // const warehouseInfo = [
    ...
    //     { image: "/images/s4.jpg", name: "Shreelakshmi", location: "Nagpur", facility: "Outdoor/Drive Up", size: "15' x 20' x 5'", rating: "4.5", price: "170", percentage: "33", area: "50", totalArea: "300" },
    // ];
    ...
    return (
        <>
            <Container fluid>
                <Row>
                    { warehouseInfo.map(StorageCard, key) }
                    <StorageCard />
                </Row>
            </Container>
        </>
